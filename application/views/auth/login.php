...
<head>
    ...
    <style>
        body {
            background: radial-gradient(circle,rgba(63, 94, 251, 1) 0%, rgba(218, 224, 254, 1) 37%, rgba(255, 255, 255, 1) 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        <div class="login-body">
            ...
            <div class="text-center mt-4">
                <small class="text-muted">
                    ...
                    Demo Account: admin1/admin123 atau pelanggan1/pelanggan123
                </small>
            </div>
        </div>
    </div>
